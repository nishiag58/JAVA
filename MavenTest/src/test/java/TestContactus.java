...
public class TestContactus {
    ...
    public void StartWeb(){
        ...
        Reporter.log("Browser Chrome hit");
        driver.get(webUrl);
        Reporter.log("Website is opened now");
    }
    ...
    public  void NameAdd()throws InterruptedException{
        ...
        String title= "Contact Us | Diaspark";
        Assert.assertEquals(driver.getTitle(),title,"assert error message test");

        Thread.sleep(2000);
        System.out.println("asssert check");
